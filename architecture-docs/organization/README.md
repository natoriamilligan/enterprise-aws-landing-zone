...
- The organization is separated into three OUs (plus the management account) to separate security operations, infrastructure management, and workloads. Each of these OUs hold accounts with similar duties which will make adding guardrails more efficient.
